...
<img src="<?= get_template_directory_uri() . '/acf/preview/cp-portrait-layout.png' ?>" style="width:100%; height:auto;"
    alt="preview">
<?php return; ?>
<?php endif; ?>

<?php
$id = 'cp-portrait-layout-' . (!empty($block['id'])) ? $block['id'] : '';
...
<div class="cp-portrait-layout teq-container">
<div class="teq-row max-w">
    <div class="col-12 col-md-3 relative left">
    ...
    <div class="col-12 col-md-7 offset-md-2 right">
